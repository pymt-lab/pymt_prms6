...
Installing pymt_prms_surface from the `conda-forge` channel can be achieved by adding
...
To install pymt_prms_surface, run this command in your terminal:

.. code-block:: console

    $ conda install pymt_prms_surface

This is the preferred method to install pymt_prms_surface, as it will always install the most recent stable release.
...
The sources for pymt_prms_surface can be downloaded from the `Github repo`_.
